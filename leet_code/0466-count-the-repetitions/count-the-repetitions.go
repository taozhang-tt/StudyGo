...
func main() {
	...
	ret = getMaxRepetitions(s1, n1, s2, n2)
	fmt.Println(ret)
}
...
func getMaxRepetitions(s1 string, n1 int, s2 string, n2 int) int {
	len1, idx1, len2, idx2 := len(s1), 0, len(s2), 0
	for idx1/len1 < n1 { //遍历 s1 n1 次
...
/**
找循环节
	参考力扣题解：https://leetcode-cn.com/problems/count-the-repetitions/solution/zhao-xun-huan-zuo-you-hua-0ms-2mb-pao-shuang-bai-b/
*/
